...
export const siteImages = {
  heroSlides: [
    { src: navImageOne, alt: 'Pradeep Maharaj Ji walking with devotees during a spiritual gathering' },
    { src: navImageTwo, alt: 'Pradeep Maharaj Ji during a spiritual discourse' },
    { src: navImageThree, alt: 'Pradeep Maharaj Ji smiling during a spiritual gathering' },
    { src: navImageFour, alt: 'Devotees gathered at a Jan Kalyan Gurukul event' },
    { src: navImageFive, alt: 'Pradeep Maharaj Ji speaking at a spiritual program' },
    { src: navImageSix, alt: 'Pradeep Maharaj Ji sharing spiritual wisdom' },
     { src: navImageSeven, alt: 'Devotees gathered at a Jan Kalyan Gurukul event' },
    { src: navImageEight, alt: 'Pradeep Maharaj Ji speaking at a spiritual program' },
    { src: navImageNine, alt: 'Pradeep Maharaj Ji sharing spiritual wisdom' },
    { src: navImageTen, alt: 'Pradeep Maharaj Ji during a spiritual gathering' },
  ],
  ...
  saintSecondary: { src: navImageThree, alt: 'Pradeep Maharaj Ji smiling during a spiritual gathering' },
  saintTertiary: { src: navImageOne, alt: 'Pradeep Maharaj Ji walking among devotees' },
  saintQuaternary: { src: navImageTwo, alt: 'Pradeep Maharaj Ji in traditional white attire' },
  saintByRiver: { src: navImageThree, alt: 'Portrait of Pradeep Maharaj Ji' },
  ...
  templeOilLamp: { src: navImageOne, alt: 'Pradeep Maharaj Ji walking with the spiritual community' },
  ...
  fireRitual: { src: navImageFour, alt: 'Spiritual program with Pradeep Maharaj Ji and devotees' },
  fireCeremony: { src: navImageOne, alt: 'Devotees walking together with Pradeep Maharaj Ji' },
  fireNight: { src: navImageFour, alt: 'Community members gathered during a spiritual program' },
  devoteesFire: { src: navImageOne, alt: 'Devotees accompanying Pradeep Maharaj Ji' },

...
export function Navbar() {
  ...
  'bg-[#F2F9FF]/95 backdrop-blur-md shadow-[0_1px_0_0_rgba(0,0,0,0.04)]'
)}
      >
            ...
            <Link
              ...
              className={cn(
                ...
                scrolled || !isHome
                  ...
                  : 'bg-ivory/15 text-ivory backdrop-blur-sm border border-ivory/30 hover:bg-ivory/25'
              )}
            >
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          />
          <div className="absolute right-0 top-0 h-full w-[80%] max-w-sm bg-ivory shadow-2xl animate-fade-in">
